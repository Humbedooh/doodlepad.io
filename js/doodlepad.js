...
var API, app, canvas, cog, connected, ctx, dataPaths, doodlepad_pid, download, draw, drawing, e, fetch, fetchNews, genColors, get, globArgs, hsl2rgb, initCanvas, isArray, lineColor, lineWidth, logbuffer, mk, mouseDown, move, pathPushTime, paths, pencil, post, postJSON, prevX, prevY, pushPaths, set, setColor, snoot_sidebar, snoot_sidebar_hide, ssh, swi, theme, threshold, txt, ws;
